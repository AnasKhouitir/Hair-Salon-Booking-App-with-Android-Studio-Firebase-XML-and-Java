...
public class Maestro extends AppCompatActivity {
    ...
    public void openProfile(View view) {
        Intent intent = new Intent(Maestro.this, ProfileActivity.class);
        startActivity(intent);
    }
    public void openProduct(View view) {
        Intent intent = new Intent(Maestro.this, Product.class);
        startActivity(intent);
    }
    public void UpenMessage(View view) {
        Intent intent = new Intent(Maestro.this, Message.class);
        startActivity(intent);
    }
}
