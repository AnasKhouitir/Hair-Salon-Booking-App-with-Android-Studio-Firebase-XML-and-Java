...
public class Royal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.royale);
    ...
    public void openProfile(View view) {
        Intent intent = new Intent(Royal.this, ProfileActivity.class);
        startActivity(intent);
    }
    public void openProduct(View view) {
        Intent intent = new Intent(Royal.this, Product.class);
        startActivity(intent);
    }
    public void YpenMessage(View view) {
